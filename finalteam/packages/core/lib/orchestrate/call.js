...
function correct(ctx, call, retry, error) {
    return __awaiter(this, void 0, void 0, function* () {
            ...
            tools: [
                {
                    ...
                    function: {
                        ...
                        parameters: ("separated" in call.operation.function
                            ...
                            ? ((_h = (_g = call.operation.function.separated) === null || _g === void 0 ? void 0 : _g.llm) !== null && _h !== void 0 ? _h : {
                                $defs: {},
                                type: "object",
                                properties: {},
                                additionalProperties: false,
        ...
        // PROCESS COMPLETION
        // ----
        const toolCall = ((_k = (_j = completion.choices[0]) === null || _j === void 0 ? void 0 : _j.message.tool_calls) !== null && _k !== void 0 ? _k : []).find(tc => tc.type === "function" && tc.function.name === call.operation.name);
